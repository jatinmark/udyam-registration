...
async function scrapeUdyamFormComprehensive() {
  ...
  try {
    ...
    console.log('Extracting comprehensive form structure...');
    
    // Based on manual inspection of the Udyam registration form
    const formSchema = {
      step1: {
        title: 'Aadhaar Number Verification',
        description: 'Enter Aadhaar number for verification and OTP generation',
        fields: [
          {
            id: 'aadhaar',
            name: 'Aadhaar Number',
          ...
          },
          {
            ...
            validation: {
              regex: '^[a-zA-Z\\s\\.]+$',
              message: 'Name should contain only letters, spaces and dots'
            }
          },
          {
            id: 'disclaimer',
            name: 'Declaration',
            type: 'checkbox',
            label: 'I, the holder of above mentioned Aadhaar Number, hereby give my consent to use my Aadhaar Number for Udyam Registration',
            required: true
          },
          {
            id: 'otp',
      ...
      step2: {
        title: 'PAN & Personal Information',
        description: 'Enter PAN and other business details',
        fields: [
          {
          ...
          },
          {
            ...
            validation: {
              minLength: 3,
              maxLength: 100,
              message: 'Enterprise name should be between 3 to 100 characters'
            }
          },
          {
            id: 'majorActivity',
      ...
      additionalInfo: {
        validationRules: {
          aadhaar: {
            ...
            description: 'Unique 12-digit identification number issued by UIDAI'
          },
          pan: {
            format: 'AAAAA9999A',
            example: 'ABCDE1234F',
            description: '10-character alphanumeric PAN issued by Income Tax Department'
          },
          mobile: {
        ...
        flowDescription: [
          ...
          'Click "Verify OTP"',
          'Fill in PAN and business details',
          'Click "Validate & Save" to proceed'
        ]
      }
    };

    // Save the comprehensive schema
    ...
    console.log(`Comprehensive form schema saved to: ${outputPath}`);
    console.log('\nForm structure has been successfully extracted!');
...
module.exports = { scrapeUdyamFormComprehensive };